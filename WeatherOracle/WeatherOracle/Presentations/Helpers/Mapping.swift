...
func mapTimeToColor(time: Int, sunset: Int) -> LinearGradient{
    let time = TimeConverter.getTimeOfDay(currentTime: time, sunset: sunset)
...
func mapTimeToImage(time: Int, sunset: Int) -> String{
    let time = TimeConverter.getTimeOfDay(currentTime: time, sunset: sunset)
