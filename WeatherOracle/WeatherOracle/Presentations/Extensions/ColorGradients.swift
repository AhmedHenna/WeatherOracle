...
extension Color {
    ...
    static let linearBackgroundMorning = LinearGradient(gradient: Gradient(colors: [Color(red: 0/255.0, green: 175/255.0, blue: 214/255.0), Color(red: 0/255.0, green: 175/255.0, blue: 214/255.0).opacity(50/255.0), Color(red: 0/255.0, green: 69/255.0, blue: 84/255.0)]), startPoint: .top, endPoint: .bottom)
